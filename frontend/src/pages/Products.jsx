          ...
          <tbody>
            {products.map((p) => (
              <tr key={p.id}>
                ...
                <td>
                  {p.delivered ? (
                    <span className="badge badge-success">已交付 ({p.deliveredDate})</span>
                  ) : (
                ...
                <td>
                  {p.customerSatisfaction ? (
                    <span style={{ color: '#ffd700' }}>{'★'.repeat(p.customerSatisfaction)}</span>
                  ) : (
                    <span style={{ color: '#8b7355' }}>未评价</span>
                  )}
                </td>
                <td>
            ...
            {products.length === 0 && (
              <tr>
                <td colSpan="12" className="empty-state">暂无成品档案</td>
              </tr>
            )}
          </tbody>
        </table>
